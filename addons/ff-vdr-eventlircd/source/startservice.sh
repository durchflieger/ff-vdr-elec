...
exec $ADDON_DIR/bin/eventlircd-lge -f --evmap=/etc/eventlircd.d --socket=/run/lirc/lircd $LIRC_CONFIG $LGE_DEVICE $LGE_OPEN_RETRY $LGE_TV_ON $LGE_TV_OFF $VERBOSE >/dev/null 2>&1
